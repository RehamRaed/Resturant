  ...
  return (
    <div className="py-10 px-4 flex justify-center">
      <div className="w-full max-w-screen-xl px-10 sm:px-15 md:px-18 lg:px-20 xl:px-20">
        <h1 className="text-3xl font-bold mb-10 text-center text-red-500">
          Customer Gallery
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {galleryImages.map((item) => (
            ...
            >
              ...
              <div className="cursor-pointer absolute inset-0 bg-black bg-opacity-60 text-white flex flex-col justify-center items-center opacity-0 group-hover:opacity-65 transition duration-500">
